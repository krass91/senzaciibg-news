...
const articles = [
  { id: "1", title: "GPT-5 ще промени начина, по който работим", excerpt: "Новите възможности на AI асистентите ще автоматизират повече задачи и ще повишат продуктивността.", category: "AI Новини", categoryClass: "category-ai-news", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800", date: "2026-04-01", readTime: "5 мин" },
