...
const articles = [
  ...
  { id: "2", title: "Как да използвате Claude за бизнес анализ", excerpt: "Практически ръководство за интегриране на AI...", category: "AI за Бизнес", categoryClass: "category-ai-business", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800", date: "2026-03-30", readTime: "8 мин" },
  { id: "3", title: "Топ 10 AI инструменти за разработчици", excerpt: "Подборка от най-полезните AI решения...", category: "AI Инструменти", categoryClass: "category-ai-tools", image: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800", date: "2026-03-28", readTime: "6 мин" },
  { id: "4", title: "Бъдещето на AI: Прогнози за 2027", excerpt: "Анализ на тенденциите...", category: "AI Тенденции", categoryClass: "category-ai-trends", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800", date: "2026-03-25", readTime: "10 мин" },
];
    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="border-b border-[#262626] py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">Новини, ръководства и AI инструменти — ChatGPT, Claude и Gemini с примери.</p>
