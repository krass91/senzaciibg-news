      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-[#171717] border border-[#262626] rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <button className="p-4 bg-[#262626] hover:bg-orange-500/20 border border-[#404040] hover:border-orange-500/50 rounded-lg transition text-left"><div className="text-xl mb-2">?</div><div className="font-semibold text-white">Добави новина</div><div className="text-sm text-gray-400">Нова статия в блога</div></button>
            ...
            <button className="p-4 bg-[#262626] hover:bg-orange-500/20 border border-[#404040] hover:border-orange-500/50 rounded-lg transition text-left"><div className="text-xl mb-2">???</div><div className="font-semibold text-white">Изтрий</div><div className="text-sm text-gray-400">Премахни статия</div></button>
          </div>
          <div className="border border-[#262626] rounded-lg overflow-hidden">
            <table className="w-full">
              <thead className="bg-[#262626]"><tr><th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Заглавие</th><th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Категория</th><th className="px-4 py-3 text-left text-sm font-semibold text-gray-300">Дата</th><th className="px-4 py-3 text-right text-sm font-semibold text-gray-300">Действия</th></tr></thead>
          ...
          <div className="mt-8 p-4 bg-[#262626] rounded-lg border border-[#404040]">
            <h3 className="font-semibold text-white mb-2">?? GitHub синхронизация</h3>
            <p className="text-gray-400 text-sm mb-4">Новините се съхраняват в GitHub repository. Промените ще бъдат автоматично качени.</p>
            <div className="flex gap-4">
              <button className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition text-sm">Sync към GitHub</button>
              <button className="px-4 py-2 bg-[#404040] hover:bg-[#505050] text-white rounded-lg transition text-sm">Презареди от GitHub</button>
            </div>
          </div>
        </div>
      </main>
